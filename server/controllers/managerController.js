...
router.get("/", async (req, res) => {
  ...
  //   active,
  // } = req.query;
  // const queryParams = { limit, skip, sortBy, orderBy, creator, search, email, id, phone, active }
  // const query = removeEmptyAttributes(queryParams);
...
router.get("/:id", async (req, res) => {
  ...
  try {
    ...
    // Prevent exposing data of non managers
...
router.put("/:id/username", async (req, res) => {
  try {
    ...
    const result = await userService.updateUsername(id, username, "manager");
...
router.put("/:id/email", async (req, res) => {
  try {
    ...
    const result = await userService.updateEmail(id, email, "manager");
...
router.put("/:id/password", async (req, res) => {
  try {
    ...
    const result = await userService.updatePassword(id, password, 'manager');
...
router.put("/:id/name", async (req, res) => {
  try {
    ...
    const result = await userService.updateName(id, name, "manager");
...
router.put("/:id/phone", async (req, res) => {
  try {
    ...
    const result = await userService.updatePhone(id, phone, "manager");
...
router.put("/:id/target", async (req, res) => {
  try {
    ...
    const result = await userService.updateName(id, target, "manager");
...
router.put("/:id/food-regime", async (req, res) => {
  try {
    ...
    const result = await userService.updateFoodRegime(id, foodRegime, "manager");
...
router.put("/:id/notes", async (req, res) => {
  try {
    ...
    const result = await userService.updateNotes(id, notes, "manager");
...
router.put("/:id/status", async (req, res) => {
  try {
    ...
    const result = await userService.updateStatus(id, active, "manager");
